...
//
// Regra Visa - inicia com 4 seguido de mais 15 digito
// Regex - ^4\d{0,15}

// Regra Master (^5[1-5]\d{0,2}|^22[2-9]\d|^2[3-7]\d{0,2})\d{0,12}

// Validação de tipo de Cartçao
...
function updateExpirationDate(date) {
  ...
  ccExpiration.innerHTML = ccExpiration.length === 0 ? "02/32" : date
}
